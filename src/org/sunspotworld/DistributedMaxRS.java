...
public class DistributedMaxRS {
  ...
  public static Vector<Object> currentObjects2 = new Vector<Object>();
  ...
  public static void main(String[] args) {
      ...
      for(int i=0; i<Constants.TOTAL_MOTES; i++){
          ...
          currentObjects2.add(new Object(p.x, p.y, val));
      }
      
      //printing values to compare
      for(int i=5; i>=0; i--){
          for(int j=0; j<6;j++){
              short val = currentValues.get((i*6)+j);
  ...
  static void initializeC_2(Vector<Short> myObjectIds, Vector<Object> myObjects, Vector<Rectangle> myRectangles){
...
///////////////////////////////////////////////////////////////////////////////////////////////////
      ...
      {
          System.out.println("obj x, y: " + currentObjects.get(i).x + ", "
                             + currentObjects.get(i).y);
          System.out.println("rectangle: x1, x2, y1, y2 " + currentRectangle.get(i).x1
                             + ", " + currentRectangle.get(i).x2 + ", "
                             + currentRectangle.get(i).y1 + ", "
                             + currentRectangle.get(i).y2);
      }

      Vector<Short> aListOfX1 = new Vector<Short>();
      for(int i = 0; i < currentRectangle.size(); i++)
      {
          aListOfX1.add(currentRectangle.get(i).x1);
          aListOfX1.add(currentRectangle.get(i).x2);
      }
      ...
      System.out.println("optimal_window score l r h: " + optimal_window.score + " "
                         + optimal_window.l + " " + optimal_window.r + " " +
                         optimal_window.h);

      meit.writeOutput("cent-output.txt", area, coverage, currentObjects, optimal_window);
  }
