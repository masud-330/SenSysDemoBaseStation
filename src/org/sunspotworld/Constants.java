...
public class Constants {
  ...
  public static final short TOTAL_MOTES = 20;
  public static final short MAX_ID = 36; // 0-35
  ...
  public static final int CEN_HOP_COUNT = 95;
  public static final int DIS_HOP_COUNT = 30;
  
    
  public static Hashtable<String, Integer> nodeIds= new Hashtable<String, Integer>();
  public static final int[] TELOSB_ID = {0,  2,  3,  5, 
                                         12, 14, 15, 17,
                                         18, 20, 21, 23,
                                         30, 32, 33, 35};
            
  public static final int[] SUNSPOT_ID = {7, 10, 25, 28}; 
  
  public static final int[] NODE_ID = {0,  2,  3,  5, 
                                       12, 14, 15, 17,
                                       18, 20, 21, 23,
                                       30, 32, 33, 35,
                                       7, 10, 25, 28};
  ...
  public static int getTelosbId(int index) {
    return TELOSB_ID[index];
  }

  public static int getSunSpotId(int index) {
    return SUNSPOT_ID[index];
  }
