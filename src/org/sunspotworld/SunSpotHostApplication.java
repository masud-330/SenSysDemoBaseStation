...
//    public static Vector<ShapeOccurrence> currentShapes= new Vector<ShapeOccurrence>();
    ...
    public static int[] lsensor_all = null;
    public static int[] tsensor_all = null;    
    /**
      ...
      public void run() {
        ...
        while(true) {
          ...
          if((sensor_type == 2) && (pck_rx.get_pck_type() == 8))
          {
            ...
            System.out.println("node index: " + node_index + " val:" +
                               pck_rx.get_payload()[0]);
            lsensor_all[node_index] = pck_rx.get_payload()[0];
        
          } else if((sensor_type == 3) && (pck_rx.get_pck_type() == 9))
          {
            int node_index = pck_rx.get_node_index();
            System.out.println("node index: " + node_index);        
            tsensor_all[node_index] = pck_rx.get_payload()[0];
  ...
  public long raw_temp_to_c(int raw) {
